...
const config = {
  ...
  gatewayMode: process.env.GATEWAY_MODE || 'rate',
  gatewayRate: int(process.env.GATEWAY_RATE, 50),
  gatewayDuration: process.env.GATEWAY_DURATION || null,
  gatewayRequests: int(process.env.GATEWAY_REQUESTS, 10_000),
  gatewayVus: int(process.env.GATEWAY_VUS, 1000),
  gatewayMaxDuration: process.env.GATEWAY_MAX_DURATION || '5m',
  gatewayPreVus: int(process.env.GATEWAY_PRE_VUS, 200),
  gatewayMaxVus: int(process.env.GATEWAY_MAX_VUS, 2000),
